 ...
 * @author USUARIO
 */
public class Vtn123 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vtn123.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
