 ...
 * @author USUARIO
 */
public class Clima_Usuario extends javax.swing.JFrame {

    /**
     * Creates new form Main
     */
    public Clima_Usuario() {
        initComponents();
        conseguirClima();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clima_Usuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clima_Usuario().setVisible(true);
            }
        });
    }
