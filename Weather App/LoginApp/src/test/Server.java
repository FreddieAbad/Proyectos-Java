...
class Server{
	...
	public void multiCuenta(){
		...
		try{
			...
			while(true){
				...
				ServidorEE cc = new ServidorEE(servicio,flujoDatosEntrada,flujoDatosSalida);  //Parametros, la conexion , y los objetos de escritura/lectura
				cc.start();
	...
	public static void main(String[] args){
		//Se crea una instancia de la clase ServidorEE
