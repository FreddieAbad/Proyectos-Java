 ...
 * @author USUARIO
 */
public class Clima_Empresario extends javax.swing.JFrame {

    private boolean minimiza;
    public Clima_Empresario() {
        initComponents();
        conseguirClima();
    }
    ...
    private void initComponents() {
        ...
        minicc = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        closeA = new javax.swing.JLabel();
        ...
        minicc.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Desktop\\Proyecto\\APP CLIENTE SERVIDOR\\Respaldos\\GUI MODERN\\IMG COMPARTIDA\\Minimize Window_20px_1.png")); // NOI18N
        minicc.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                miniccMouseClicked(evt);
            }
        });
        pnl_weather_admin.add(minicc, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, -1, -1));
        ...
        closeA.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Desktop\\Proyecto\\APP CLIENTE SERVIDOR\\Respaldos\\GUI MODERN\\Close Window_40px.png")); // NOI18N
        closeA.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                closeAMouseClicked(evt);
            }
        });
        pnl_weather_admin.add(closeA, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 0, -1, -1));
    ...
    private void closeAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_closeAMouseClicked
        VtnEmpresarioSecundaria vtnsA=new VtnEmpresarioSecundaria();
        vtnsA.setLocationRelativeTo(null);
        vtnsA.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_closeAMouseClicked

    private void miniccMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_miniccMouseClicked
    ...
    }//GEN-LAST:event_miniccMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clima_Empresario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clima_Empresario().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel closeA;
    ...
    private javax.swing.JLabel minicc;
