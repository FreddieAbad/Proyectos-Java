 ...
 * @author proxc
 */
public class VtnTaxistaSecundaria extends javax.swing.JFrame {

    private boolean minimiza;
    public VtnTaxistaSecundaria() {
        initComponents();
    ...
    private void initComponents() {
        ...
        pnl_climaA = new javax.swing.JPanel();
        ...
        pnl_header.setBackground(new java.awt.Color(255, 197, 25));
        ...
        info_usuario.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Desktop\\Proyecto\\APP CLIENTE SERVIDOR\\Respaldos\\GUI MODERN\\IMG TAXI\\Taxi_40px.png")); // NOI18N
        ...
        pnl_climaA.setBackground(new java.awt.Color(130, 130, 130));
        pnl_climaA.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                pnl_climaAMouseClicked(evt);
            }
        });

        fecha_principal.setFont(new java.awt.Font("Segoe UI Semilight", 0, 18)); // NOI18N
        fecha_principal.setForeground(new java.awt.Color(255, 255, 255));
        fecha_principal.setText("Ver Estado Metereologico");

        javax.swing.GroupLayout pnl_climaALayout = new javax.swing.GroupLayout(pnl_climaA);
        pnl_climaA.setLayout(pnl_climaALayout);
        pnl_climaALayout.setHorizontalGroup(
            pnl_climaALayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnl_climaALayout.createSequentialGroup()
                .addGap(39, 39, 39)
                .addComponent(fecha_principal, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(34, Short.MAX_VALUE))
        );
        pnl_climaALayout.setVerticalGroup(
            pnl_climaALayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(pnl_climaALayout.createSequentialGroup()
                .addGap(22, 22, 22)
        ...
        pnl_weather_admin.add(pnl_climaA, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 180, 280, 70));
        ...
        btn_admin_imandar_boletin1.setBackground(new java.awt.Color(255, 192, 5));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(pnl_estadistica, javax.swing.GroupLayout.PREFERRED_SIZE, 642, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_admin_imandar_boletin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_admin_imandar_boletin1ActionPerformed
        MapasPrincipalTaxi mps=new MapasPrincipalTaxi();
        this.dispose();
        mps.setLocationRelativeTo(null);
        mps.setExtendedState(MAXIMIZED_BOTH);
        mps.setVisible(true);
    ...
    private void pnl_climaAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnl_climaAMouseClicked
        dispose();
        ...
        new java.util.Timer().schedule(new TimerTask() {
            @Override
            public void run() {
                Clima_Taxi vtnIT= new Clima_Taxi();
    ...
    }//GEN-LAST:event_pnl_climaAMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VtnTaxistaSecundaria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VtnTaxistaSecundaria().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel pnl_climaA;
