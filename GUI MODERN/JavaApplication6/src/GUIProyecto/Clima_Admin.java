 ...
 * @author USUARIO
 */
public class Clima_Admin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        minic = new javax.swing.JLabel();
        jLabel1 = new javax.swing.JLabel();
        jLabel2 = new javax.swing.JLabel();
        cerrarAA = new javax.swing.JLabel();
        ...
        minic.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Desktop\\Proyecto\\APP CLIENTE SERVIDOR\\Respaldos\\GUI MODERN\\IMG COMPARTIDA\\Minimize Window_20px_1.png")); // NOI18N
        minic.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                minicMouseClicked(evt);
            }
        });
        pnl_weather_admin.add(minic, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 10, -1, -1));
        ...
        cerrarAA.setIcon(new javax.swing.ImageIcon("C:\\Users\\USUARIO\\Desktop\\Proyecto\\APP CLIENTE SERVIDOR\\Respaldos\\GUI MODERN\\Close Window_40px.png")); // NOI18N
        cerrarAA.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cerrarAAMouseClicked(evt);
            }
        });
        pnl_weather_admin.add(cerrarAA, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 0, -1, -1));
    ...
    private void cerrarAAMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cerrarAAMouseClicked
        VtnAdmin_Principal vtnsAA=new VtnAdmin_Principal();
        vtnsAA.setLocationRelativeTo(null);
        vtnsAA.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_cerrarAAMouseClicked

    private void minicMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_minicMouseClicked
    ...
    }//GEN-LAST:event_minicMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Clima_Admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Clima_Admin().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel cerrarAA;
    ...
    private javax.swing.JLabel minic;
